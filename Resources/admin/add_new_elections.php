...
<body>
  ...
  text-shadow: 2px 2px 4px #000000;">E-Vote</h1>
    ...
    if (isset($_POST['add_elections'])) {
        ...
        if ($run) {
            $success = "<b><p class='text text-center text-danger'><span class='glyphicon glyphicon-flash' aria-hidden='true' style='color:red'></span> Elections added SUccesfully...!</p></b>";
        } else {
            $error = "<p class='text text-center text-danger'>TRY AGAIN</p>";
        }
    }
    ?>
        ...
        <div class="row">
            <div class="col-sm-6" >
                <div class="single-service">
                    <img src="images/Add-Telegram-Members.jpg">
                    <div class="overlay"></div>
                    <div class="service-desc">
                        <h3>ADD Election Panel</h3>
                        <hr>
                        <p> Here as an Admin, you can ADD an <i>Election</i> anytime. You can set <i>Starting Date</i> as well as <i>Ending Date</i> of that election.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6  alert alert-info" style="box-shadow: 3px 3px 3px 3px black;">
                ...
                <form method="POST">
                    <h4 class="text text-center bg-primary alert" style="color: white ;"><span class='glyphicon glyphicon-paperclip' aria-hidden='true' style='color:gold'></span> ADD New Election</h4>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="elections_name" id="" class="form-control" placeholder="Enter Election Name..." required>
                    </div>

                    <div class="form-group">
                        <label for="elections_start_date">Election Start Date :</label>
                        <input type="date" name="elections_start_date" class="form-control" placeholder="Enter your password..." required>
                    </div>

                    <div class="form-group">
                        <label for="elections_end_date">Election End Date :</label>
                        <input type="date" name="elections_end_date" class="form-control" placeholder="Enter your password..." required>
                    </div>

                    <div class="form-group">
                        <button type="submit" class="btn btn-success btn-block" name="add_elections"> <span class='glyphicon glyphicon-log-in' aria-hidden='true' style='color:gold'></span>    ADD Election</button>
