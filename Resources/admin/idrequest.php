...
<div class="container">
        <div class="col-md-8 col-md-offset-2 alert alert-info" style="box-shadow: 3px 3px 3px 3px black;">
        <h4 class="text text-center bg-primary alert" style="color: white ;"><span class='glyphicon glyphicon-list' aria-hidden='true' style='color:gold'></span> All ID Requests</h4> 
                    ...
                    if($run->num_rows>0)
                    {
                        ...
                        while($row=$run->fetch_array())
                        {
                            ...
                            <tr class="table-primary">
                                ...
                                <td>
                                    <a href="updateid.php?id=<?php echo $id?>" style="color:red;">Update</a>
                                </td>
                            </tr>
                            <?php
                        }
