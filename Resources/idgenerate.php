...
<body>
    <div class="bgg">
        ...
        <div class="container" >
            ...
            if ($run->num_rows > 0) {
            ?>
                <div class="col-sm-6 col-sm-offset-3 bg-success alert" style="box-shadow: 3px 3px 3px 3px black;">
                    <h4 class="text text-center" style="color: red; padding-top:10px"><span class='glyphicon glyphicon-warning-sign' aria-hidden='true'style='color:red'></span> You have already submitted ID-request! please WAIT</h4>
                </div> <br> <br> <br> <br> <br>
            <?php
            } else {
            ?>
                ...
                ?>
                    <div class="col-sm-6 col-sm-offset-3 bg-info alert"style="box-shadow: 3px 3px 3px 3px black;">
                        <h4 class="text text-center" style="padding-top:10px;">
                            Your ID is: <b><span class="text text-danger"><?php echo $user_id_generated ?> </span></b>
                        </h4>
                        <p class="text text-center"><b>Note: </b> <i> "Use this ID & login_password to cast ur vote" </i></p> <br>
                        <div class="form-group">
                            <button type="submit" class="btn btn-info btn-block" name="" onclick="window.print();" target="_blank";> <i class="fa fa-print"></i>    PRINT</button>
                        </div>
                    </div> <br> <br> <br> <br> <br>
                <?php
                } else {
...
if (isset($_POST['idrequest'])) {
    ...
    if ($run) {
        echo "<script> location.href='idgenerate.php'; </script>";
    }
}
...
?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 alert alert-success" style="box-shadow: 2px 2px 2px 2px black;">

                    <form method="POST">
                        <h4 class="text text-center bg-primary alert" style="color: white ;"><span class='
glyphicon glyphicon-hourglass' aria-hidden='true'style='color:gold'></span> ID Generation</h4>

                        <div class="form-group">
                            <label for="Username">User Name :</label>
                            <input type="text" name="user_name" id="" class="form-control" value="<?php echo $user_name ?>" readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="user_province" class="form-control" placeholder="Enter your password..." required value="<?php echo $user_province ?>" readonly>
                        </div>

                        <div class="form-group">
                            <button type="submit" class="btn btn-info btn-block" name="idrequest" onclick="alert('Your ID Request Submitted')"><span class='
                            glyphicon glyphicon-cloud-upload' aria-hidden='true'style='color:gold'></span> REQUEST</button>
                        </div>
                    </form>
                </div>
            </div>
...
<div class="container"style="width: 100%;background: linear-gradient(white, skyblue);">
        <div class="row">
            <h4 class="text text-center"> &copy; <i>Copyrights Argho'1807066 </i>  </h4>
        </div>
